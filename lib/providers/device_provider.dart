...
class DeviceProvider with ChangeNotifier {
  ...
  // -------------------------------
  // Nuevo getter: conexión
  // -------------------------------
  // Devuelve true si al menos un dispositivo está conectado
  bool get isConnected => _devices.any((d) => d.connected);
  ...
  void loadMockDevices() {
    _devices.clear();
    _devices.addAll([
      Device(id: "1", name: "Timbre Principal", ip: "192.168.0.101", online: true),
      Device(id: "2", name: "Timbre Secundario", ip: "192.168.0.102", online: false),
      Device(id: "3", name: "Timbre Patio", ip: "192.168.0.103", online: false),
    ]);
    notifyListeners();
  }
