      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: InputDecoration(labelText: 'Nombre del horario'),
          ),
          actions: [
            TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Horarios'),
        actions: [
          IconButton(onPressed: _saveHorarios, icon: Icon(Icons.save)),
          IconButton(onPressed: _crearHorario, icon: Icon(Icons.add)),
        ],
      ),
          ...
          return Card(
            child: ExpansionTile(
              ...
              children: [
                ...
                ListTile(
                  title: Text(
                      "ESP asignados: ${horario.espAsignados.join(', ') == '' ? 'Ninguno' : horario.espAsignados.join(', ')}"),
                  trailing: IconButton(
